...
class CIMSMode(MeasurementMode):
    def __init__(
        ...
        # address_pulsegenerator: str,
        # address_gaussmeter: str,
        # address_switch: str,
        # delay_field: float,
        # delay_measurement: float,
        # delay_bias: float,
        ...
        # pulsegenerator_duration,
        # pulsegenerator_offset,
        # pulsegenerator_pulsetype,
        # pulsegenerator_channel,
        # pulsegenerator_compliance,
        # pulsegenerator_source_range,
        # field_bias_value,
        # remagnetization,
        # remagnetization_value,
        # remagnetization_time,
        # hold_the_field_after_measurement,
        # remanency_correction,
        # remanency_correction_time,
        # set_polar_angle,
        # set_azimuthal_angle,
    ) -> None:
    ...
    def initializing(self):
        ...
        if self.p.remagnetization:
            ...
            if self.p.remanency_correction:
                ...
                sweep_field_to_value(0, self.p.remagnetization_value - self.actual_remanency, self.p.field_constant, self.p.field_step, self.field_obj)
                sleep(self.p.remagnetization_time)
                print("to zero:")
                sweep_field_to_value(
                    self.p.remagnetization_value - self.actual_remanency, self.p.field_bias_value, self.p.field_constant, self.p.field_step, self.field_obj
                )
                sleep(self.p.remanency_correction_time)
