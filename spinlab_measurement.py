...
#################################################################### PARAMETERS #####################################################################
    ...
    set_modulation = ListParameter("Modulation", default = parameters_from_file["set_modulation"], choices = ["SR830", "none"], group_by = {"mode": lambda v: v == "FMRMode"})
    ...
    modulation_freq = FloatParameter("Modulation Frequency", default = parameters_from_file["modulation_freq"], units="Hz", group_by = {"mode": lambda v: v == "FMRMode", "set_generator": lambda v: v != "none", "set_modulation": lambda v: v == True})
    modulation_amp = FloatParameter("Modulation Amplitude", default = parameters_from_file["modulation_amp"], units="V", group_by = {"mode": lambda v: v == "FMRMode", "set_generator": lambda v: v != "none", "set_modulation": lambda v: v == True})
...
class MainWindow(ManagedDockWindow):
    ...
    def __init__(self):
        super().__init__(
            ...
            inputs = ['mode', 'sample_name', 'vector', 'mode_resistance', 'mode_fmr', 'mode_harmonic', 'set_sourcemeter', 'set_multimeter', 'set_gaussmeter', 'set_field', 'set_lockin', 'set_generator', 'set_modulation', 'set_automaticstation', 'set_rotationstation','set_switch', 'set_kriostat', 'set_analyzer',  'address_sourcemeter', 'address_multimeter','address_daq' , 'address_gaussmeter', 'address_lockin', 'address_switch', 'address_analyzer', 'address_generator', 'sourcemter_source', 'sourcemeter_compliance', 'sourcemeter_channel', 'sourcemeter_limit', 'sourcemeter_nplc', 'sourcemeter_average', 'sourcemeter_bias', 'multimeter_function', 'multimeter_resolution','multimeter_nplc', 'multimeter_autorange', 'multimeter_range', 'multimeter_average', 'field_constant', 'gaussmeter_range', 'gaussmeter_resolution', 'lockin_average', 'lockin_input_coupling', 'lockin_reference_source', 'lockin_dynamic_reserve', 'lockin_input_connection', 'lockin_sensitivity','lockin_frequency', 'lockin_harmonic','lockin_sine_amplitude',  'lockin_timeconstant', 'lockin_channel1','lockin_channel2' ,  'lockin_autophase','generator_frequency', 'modulation_freq', 'modulation_amp' ,'generator_power','set_field_value', 'delay_field', 'delay_lockin', 'delay_bias'],
