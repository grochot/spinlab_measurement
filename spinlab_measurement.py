...
#################################################################### PARAMETERS #####################################################################
    ...
    pulsegenerator_sourcerange=FloatParameter("Pulsegenerator sourcerange", default = parameters_from_file["pulsegenerator_sourcerange"], group_by={"mode": lambda v: v == "CIMSMode", "set_pulsegenerator": lambda v: v == "Keithley 2636"})
