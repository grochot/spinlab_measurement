    ...
    def startup(self):
        ...
        match self.mode:
            ...
            case "HarmonicMode":
                ...
                self.selected_mode = HarmonicMode(self)
            case "FMRMode":
                ...
                self.selected_mode = FMRMode(self)
