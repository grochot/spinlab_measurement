...
#################################################################### PARAMETERS #####################################################################
    ...
    set_measdevice_fmr = ListParameter("Measurement Device", choices=["LockIn", "Multimeter"], default=parameters_from_file["set_measdevice_fmr"], vis_cond=lambda layout_type, mode: layout_type == False and mode == "FMRMode")
    set_measdevice_qm = ListParameter("Measurement Device", choices=["Sourcemeter", "Multimeter"], default=parameters_from_file["set_measdevice_qm"], vis_cond=lambda layout_type, mode: layout_type == False and mode == "QuickMeasurement")
    ...
    address_daq = ListParameter("DAQ address", default = parameters_from_file["address_daq"],  choices=["Dev4/ao0"], vis_cond=lambda layout_type, mode, set_field: layout_type == False and (mode == "ResistanceMode" or mode == "HarmonicMode" or mode == "FMRMode" or mode == "CalibrationFieldMode" or mode=="CIMSMode") and set_field != "none")
